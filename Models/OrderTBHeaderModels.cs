...
namespace mascis.Models
{
    class OrderTBHeaderModels
    {
        ...
        public Order_TB_Header GetRecordByKey(string order_no)
        {
            try
            {
        ...
        //public Boolean SaveLog(Order_TB_Header record)
        //{
        //    try
        //    {
        //        var log = new Order_TB_Header_Log
        //        {
        ...
        //        };
        //        context.Order_TB_Header_Log.Add(log);
        //        context.SaveChanges();
        //        return true;
        //    }
        //    catch (Exception e)
