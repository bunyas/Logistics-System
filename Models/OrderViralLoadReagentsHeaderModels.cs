...
{
    class OrderViralLoadReagentsHeaderModels
    {
        ...
        public Order_ViralLoadReagents_Header GetRecordByKey(string order_no)
        {
            try
            {
        ...
        public Boolean SaveLog(Order_ViralLoadReagents_Header record)
        {
            try
            {
                var log = new Order_ViralLoadReagents_Header_Log
                {
                ...
                context.Order_ViralLoadReagents_Header_Log.Add(log);
                context.SaveChanges();
                return true;
            }
            catch (Exception e)
