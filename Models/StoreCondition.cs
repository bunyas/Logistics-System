...
namespace mascis.Models
{
    public class StoreCondition
    {
        ...
        public string Q_7 { get; set; }
        public string Q_8 { get; set; }
        public string Q_9 { get; set; }
        public string Q_10 { get; set; }
        public string Q_11 { get; set; }
        public string Q_12 { get; set; }
        public string Q_13 { get; set; }
